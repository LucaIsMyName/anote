...
const TableOfContents = memo(({ blocks, onHeadingClick }: TableOfContentsProps) => {
  ...
  return (
    <details
      open
      className="select-none lg:sticky top-8 bg-white/50 backdrop-blur-sm border-gray-200 mb-8 lg:max-h-[calc(100vh-2rem)] overflow-y-auto pt-0 pb-8 border-b-2 lg:border-b-0">
