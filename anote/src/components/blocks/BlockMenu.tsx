...
export const ParagraphBlock = memo(({ content, onChange, workspace, onPageClick }: ParagraphBlockProps) => {
...
export const HeadingBlock = ({ content, onChange }: HeadingBlockProps) => {
